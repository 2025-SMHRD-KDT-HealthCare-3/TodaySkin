...
6. [스페셜 케어] 주 1~2회 하는 집중 케어로 평소 루틴과 반드시 달라야 해요.
   - 반드시 아침/저녁 루틴과 다른 특별한 케어로만 구성하세요.
   - 피부 타입과 점수에 맞는 스페셜 케어를 추천하세요:
     * 지성/여드름: 살리실산 각질제거 → 클레이 마스크팩 순서로
     * 건성: 수분 앰플 집중 도포 후 수분 시트팩
     * 복합성: T존 클레이팩 + U존 수분팩 동시 적용
     * 민감성: 저자극 진정 앰플 후 진정 마스크팩
     * 노화(30대 이상): 레티놀/콜라겐 앰플 집중 케어
   - 보유 화장품 중 스페셜 케어에 적합한 제품 우선 활용
   - 없으면 추천 후보 DB에서 찾고, 그것도 없으면 필요한 제품 유형 안내
