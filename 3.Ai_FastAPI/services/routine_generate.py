...
사용자의 피부 정보와 보유 화장품을 분석하여 최적의 루틴을 설계하세요.
...
4. [스페셜 케어] 
   - 특정 제품을 추천하지 말고, 집에서 할 수 있는 구체적인 '관리 방법 가이드'를 제안하세요.
   - 반드시 cos_name: null 로 작성하세요.
   - description에 방법(예: 스팀타월, 7스킨법 등)을, recommend_reason에 생리학적 필요성을 작성하세요.
